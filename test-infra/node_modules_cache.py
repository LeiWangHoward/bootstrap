...
def download(directory):
    ...
    try:
        print("Downloading {} tarball from S3...".format(directory))
        key.get_contents_to_filename(_tarball_filename_for(directory))
    except S3ResponseError as err:
        open(NEED_TO_UPLOAD_MARKER, 'a').close()
        print(err)
        raise SystemExit("Cached {} download failed!".format(directory))
...
def upload(directory):
    ...
    print("Uploading {} tarball to S3... ({})".format(directory, _tarball_size(directory)))
